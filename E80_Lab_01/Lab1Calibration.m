...
True_ZeroX_1 = ZeroX_Test1 * Scale_Factor;
True_ZeroY_1 = ZeroY_Test1 * Scale_Factor;
True_GravityZ_1 = GravityZ_Test1 * Scale_Factor;

% Test 2 Data Conversion
True_ZeroY_2 = ZeroY_Test2 * Scale_Factor;
True_ZeroZ_2 = ZeroZ_Test2 * Scale_Factor;

% Test 3 Data Conversion
True_ZeroX_3 = ZeroX_Test3 * Scale_Factor;
True_ZeroZ_3 = ZeroZ_Test3 * Scale_Factor;
